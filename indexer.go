...
func EventIndexCallback(orm *gorm.DB, u *UnmarshalSDKWrapper, transferEventTracker TransferEventTracker, txLogs []ethrpc.Log, ethClient *EthBlockChainRPCWithRetry) error {
		...
		for true {
			...
			for i := 0; i < parallelCallForDB; i++ {
				...
				go func(routineReceiptLog Receipts) {
					...
					err := EventIndexCallback(orm, unmarshalSDKWrapper, transferEventTracker, routineReceiptLog.receipts, ethRPCClient)
					if err != nil {
